...
<body class="text-black font-poppins pt-10 pb-[50px]">
    <div id="hero-section" style="background-image: url('{{ asset('assets/background/Hero-Banner.png')}}');" class="max-w-[1200px] mx-auto w-full h-[393px] flex flex-col gap-10 pb-[50px] bg-center bg-no-repeat bg-cover rounded-[32px] overflow-hidden absolute transform -translate-x-1/2 left-1/2">
                ...
                <div class="flex flex-col gap-3">
                    <div class="group p-[12px_16px] flex items-center gap-[10px] bg-[#E9EFF3] rounded-full hover:bg-[#3525B3] transition-all duration-300">
                        ...
                        <a href="{{ route('front.details',$course) }}">
                            <p class="font-semibold transition-all duration-300 group-hover:text-white"> Trailer </p>
                        </a>
                    </div>
                    ...
                    @php
                        ...
                        $is_active = $currentVideoId == $video->id;
                    @endphp

                    <div class="group p-[12px_16px] flex items-center gap-[10px] rounded-full hover:bg-[#3525B3] {{ $is_active ? 'bg-[#3525B3]' : 'bg-[#E9EFF3]' }} transition-all duration-300">
                        @if ($is_active)
                        ...
                        <a href="{{ route('front.learning', [$course, 'courseVideoId' => $video->id ]) }}">
                            <p class="font-semibold transition-all duration-300 group-hover:text-white {{ $is_active ? 'text-white' : 'text-black' }}">{{ $video->name }}</p>
                        </a>
                    </div>
                            ...
                            <div class="flex items-center justify-between w-full">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex flex-col gap-[2px]">
                                        ...
                                        <p class="text-sm text-[#6D7786]">{{ $course->teacher->user->eccupation }}</p>
                                    </div>
                                </div>
