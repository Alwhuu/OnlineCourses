            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{route('admin.courses.update', $course)}}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4"> 
                        ...
                        <x-text-input id="path_trailer" class="block mt-1 w-full" type="text" name="path_trailer" :value="old('path_trailer', $course->path_trailer)"                            required autofocus autocomplete="path_trailer" />
